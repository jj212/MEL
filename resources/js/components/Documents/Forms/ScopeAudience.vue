    ...
    <div class="col-md-12">
        <form class="form-horizontal" @submit.prevent="scopeAudienceForm">
            ...
            <div class="form-group has-feedback has-feedback-left">
                ...
                <ckeditor name="scopeaudience" :editor="editor" v-model="document.approach.scope_audience" :config="editorConfig" placeholder="Approach scope audience text here ..." id="scopeaudience"></ckeditor>
            ...
            <fieldset>
                ...
                <div v-for="tbl in document.approach.scope_audience_tbl" style="padding: 10px 40px; border: 2px dashed lightcoral;">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" v-model="tbl.name" placeholder="Ex. Program implementation partners ...">
                    </div>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <tr v-for="item in tbl.data">
                                ...
                                <td>
                                    <ckeditor name="need" v-model="item.need" :editor="editor" :config="editorConfig" placeholder="Information needs text here ..."></ckeditor>
                                </td>
                            </tr>
                            <tr>
                                <td></td>
